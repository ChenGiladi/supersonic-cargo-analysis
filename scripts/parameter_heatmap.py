...
sfc_labels = ['(a) SFC = 20 (optimistic)',
              '(b) SFC = 27.5 (baseline aero)',
              '(c) SFC = 35 (conservative cargo)']
...
marker_specs = {20: ('^', '#1b7837', 1.8, 8.0, 'Optimistic', (10, -16)),
                27.5: ('*', 'black', 1.8, 7.0, 'Baseline aero', (10, 8)),
                35: ('v', '#b2182b', 1.8, 6.0, 'Conservative cargo', (10, 10))}
...
for idx, (sfc, label) in enumerate(zip(sfc_levels, sfc_labels)):
    ...
    lbls = ax.clabel(cs, inline=True, fontsize=13,
    ...
    if idx == 0:
        ax.set_ylabel('L/D ratio', fontsize=15)
...
cbar.set_label('Block CO$_2$ intensity (kg/ton-km)', fontsize=15, labelpad=8)
